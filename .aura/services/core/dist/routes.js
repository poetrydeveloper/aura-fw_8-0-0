 ...
 */
exports.router.post('/sync-shell', async (req, res) => {
    try {
        ...
        await db_1.db.syncShellWithMutation({
            shell_id: shell_id,
        ...
        await weaver_1.weaver.weaveProject();
 ...
 */
exports.router.post('/rollback-shell', async (req, res) => {
    try {
        ...
        try {
            ...
            commitSha = (0, child_process_1.execSync)(gitLogCmd, { encoding: 'utf-8' }).trim();
        }
        catch (gitErr) {
